        ...
        <div className="mt-3">
          {upcoming.length > 0 &&
            upcoming.map((event) => (
              <div
                key={event.id}
                className={`p-3 ml-10 rounded-md shadow-lg my-5 relative pl-5`}
              >
                <div className="font-semibold z-40 left-0 translate-x-[-100%] top-0 bottom-0 flex flex-col justify-between items-start px-2 absolute text-sm">
                  <p>
