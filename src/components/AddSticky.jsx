...
<div className="relative">
  ...
  >
    <div
      ...
      `}
    >
      <p className={`text-sm font-semibold ${preferences.darkMode ? "text-white/80" : "text-slate-800"}`}>
        Note
      </p>
      <p className={`text-xs mt-1 ${preferences.darkMode ? "text-white/55" : "text-slate-500"}`}>
    ...
    <div className="flex justify-between items-center">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className={`text-xs ${preferences.darkMode ? "text-white/60" : "text-slate-500"}`}>
