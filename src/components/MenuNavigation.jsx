 ...
 return (
  ...
  >
   ...
   <div
    ...
    onClick={() => setShowCategory(prev => (prev !== "task" ? "task" : null))}
   >
    <BsListTask />
   ...
   <div
    ...
    onClick={() => setShowCategory(prev => (prev !== "event" ? "event" : null))}
   >
    <BsFillCalendar2EventFill />
   ...
   <div
    ...
    onClick={() =>
     setShowCategory(prev => (prev !== "groupevent" ? "groupevent" : null))
    }
   >
    <HiUserGroup />
   ...
   <div
    ...
    onClick={() =>
     setShowCategory(prev => (prev !== "stickynote" ? "stickynote" : null))
    }
   >
    <FaStickyNote />
   ...
   <div
    ...
    onClick={() =>
     setShowCategory(prev => (prev !== "appointment" ? "appointment" : null))
    }
   >
    <AiFillSchedule />
