const authorizeDelete = (paramName, prismaModel) => async (req, res, next) => {
  ...
  try {
    ...
    return res.status(500).json({
      message:
        "We apologize for the inconvenience. Something Went wrong on the server, please give us some time to fix the issue and try again",
    });
  }
};
